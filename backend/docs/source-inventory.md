...
|---|---|---|---|
| IEC election results | `scripts/discover_iec_sources.py`; metadata/manifest ingestion `scripts/ingest_iec_metadata_manifest.py` (design: `docs/iec-election-results-ingestion.md`) | `reports/iec_source_discovery.json` / `.md`; `reports/iec_metadata_manifest_report.json` / `.md` | **Metadata + source manifests ingested** (`iec_elections`, `iec_source_manifests`) — **no vote totals, winners, office-bearers, or geography/party mappings** |
