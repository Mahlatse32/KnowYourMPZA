...
def main() -> None:
    ...
    _run(["python", "scripts/ingest_all_people_assembly.py", "--limit", max_urls, "--sleep", sleep])
    _run(["python", "scripts/ingest_all_committees.py", "--limit", max_urls, "--sleep", sleep])
    _run(["python", "scripts/regenerate_aliases.py"])
